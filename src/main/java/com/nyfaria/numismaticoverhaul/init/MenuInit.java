...
public class MenuInit {
    ...
    public static final RegistryObject<MenuType<ShopScreenHandler>> SHOP = MENU_TYPES.register("shop", () -> new MenuType<>(ShopScreenHandler::new, FeatureFlags.DEFAULT_FLAGS));
