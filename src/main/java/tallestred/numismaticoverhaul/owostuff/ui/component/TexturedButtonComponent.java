...
import tallestred.numismaticoverhaul.mixin.owomixins.ui.ClickableWidgetAccessor;
...
/**
 * @deprecated Replaced by {@link ButtonComponent.Renderer#texture(ResourceLocation, int, int, int, int)}
 */
