...
public class OwoNinePatchRenderers {
    ...
    private static final ResourceLocation SCROLLBAR_TEXTURE = ResourceLocation.fromNamespaceAndPath("owo", "textures/gui/scrollbar.png");
    ...
    private static final ResourceLocation BUTTON_TEXTURE = ResourceLocation.fromNamespaceAndPath("owo", "textures/gui/buttons.png");
