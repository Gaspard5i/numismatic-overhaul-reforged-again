package tallestred.numismaticoverhaul.owostuff.ui.container;
...
import tallestred.numismaticoverhaul.owostuff.ui.util.MountingHelper;
    ...
    public void layout(Size space) {
        ...
        if (this.verticalAlignment() != VerticalAlignment.TOP) {
            for (var component : layout) {
                component.owoSetY(component.y() + this.verticalAlignment().align(component.fullSize().height(), this.height - padding.vertical()));
            }
        }
        ...
        if (this.horizontalAlignment() != HorizontalAlignment.LEFT) {
            for (var component : layout) {
                if (this.horizontalAlignment() == HorizontalAlignment.CENTER) {
                    component.owoSetX(component.x() + (this.width - padding.horizontal() - layoutWidth.intValue()) / 2);
                } else {
                    component.owoSetX(component.x() + (this.width - padding.horizontal() - layoutWidth.intValue()));
                }
            }
        }
